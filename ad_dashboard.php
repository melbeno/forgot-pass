    ...
    if ($_GET['page'] === 'home') {
        ...
        if (isset($user_data['ad_username'])) {
            ...
            echo "<div id='profile-section'>
                    ...
                    <p>".$user_data['ad_address'] . "</p>
                    <p>".$user_data['ad_phone'] . "</p>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_admin'])) {
    ...
    $new_phone = mysqli_real_escape_string($con, strval($_POST['new_phone']));
    ...
    $update_query = "UPDATE admin SET ad_username = '$new_username', ad_password = '$new_password', ad_phone = $new_phone, ad_address = '$new_address' WHERE ad_id = " . $user_data['ad_id'];

    if (mysqli_query($con, $update_query)) {
        echo "Admin details updated successfully!";
        echo "Generated Query: " . $update_query . "<br>";
    } else {
...
if (isset($admin_data)) {
    ...
    <div class="login-container">
        <form action="" method="post">
            ...
            <br>
            <label for="new_phone">New Phone Number:(optional)</label>
            <input type="text" id="new_phone" name="new_phone" value="<?php echo $admin_data['ad_phone'];?>" required>
            <br>
            <label for="new_address">New Address:(optional)</label>
            <input type="text" id="new_address" name="new_address" value="<?php echo $admin_data['ad_address'];?>" required>
            <br>
