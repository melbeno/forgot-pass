<?php
    ...
    try {
        ...
        $mail->Body    = 'To reset your password click <a href="http://localhost/change_password.php?verify_token='.$code.'">here </a>. </br>';
        ...
        $verifyQuery = $conn->query("SELECT * FROM admin WHERE ad_email = '$email'");

        if($verifyQuery->num_rows) {
            $codeQuery = $conn->query("UPDATE admin SET verify_token = '$code' WHERE ad_email = '$email'");
